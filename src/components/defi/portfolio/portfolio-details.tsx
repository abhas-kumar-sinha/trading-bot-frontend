...
const PortfolioDetails = ({ data, index }: PortfolioDetailsProps) => {
    const strokeWidth = 12;
    const radius = (data.size - strokeWidth) / 2.5;
            ...
            {activities.map((activity) => (
                <motion.div key={activity.label} className="flex flex-col">
                    ...
                    >
                        ...
                        <span className="text-sm ml-1 text-zinc-600 dark:text-zinc-400">
                            {activity.unit}
                        </span>
                    </span>
                </motion.div>
...
export default function AppleActivityCard({
    ...
    return (
        <div
            className={cn(
                "relative w-75 max-w-3xl mx-auto rounded-3xl",
